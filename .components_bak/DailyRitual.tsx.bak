                ...
                >
                    ...
                    <div className="grid md:grid-cols-3 gap-4 relative z-10">
                        {(['amor', 'dinheiro', 'carreira'] as const).map((focusKey, idx) => {
                            ...
                            const colorClasses = {
                                amor: {
                                    selected: "bg-rose-600/20 border-rose-500 text-rose-200 shadow-[0_0_30px_rgba(244,63,94,0.3)]",
                                    default: "bg-white/5 border-white/10 text-slate-400 hover:bg-rose-900/20 hover:border-rose-500/50 hover:text-rose-200"
                                },
                                dinheiro: {
                                    selected: "bg-emerald-600/20 border-emerald-500 text-emerald-200 shadow-[0_0_30px_rgba(16,185,129,0.3)]",
                                ...
                                carreira: {
                                    selected: "bg-blue-600/20 border-blue-500 text-blue-200 shadow-[0_0_30px_rgba(59,130,246,0.3)]",
