            ...
            <div className="flex-1 text-center lg:text-left max-w-2xl lg:pl-8">
              ...
              <BlurFade delay={0.4}>
                <p className="text-lg md:text-xl text-slate-400 mb-10 leading-relaxed max-w-lg mx-auto lg:mx-0">
                  Encontre o <span className="text-gold-300 font-medium">ouro escondido</span> no seu dia a dia. Um guia prático para você enxergar oportunidades que passariam despercebidas e tomar decisões com total clareza.
                </p>
              </BlurFade>
